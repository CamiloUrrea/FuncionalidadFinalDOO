package co.edu.uco.backend.data.dao.entity.municipio.impl.azuresql;
...
public class MunicipioAzureSQLDAO implements MunicipioDAO {

    private final Connection connection;

    public MunicipioAzureSQLDAO(Connection connection) {
