package co.edu.uco.backend.data.dao.entity.tipocancha.impl.azuresql;
...
public class TipoCanchaAzureSQLDAO implements TipoCanchaDAO {

    private final Connection connection;

    public TipoCanchaAzureSQLDAO(Connection connection) {
