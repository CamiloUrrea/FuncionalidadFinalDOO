package co.edu.uco.backend.data.dao.entity.horarioespecial.impl.azuresql;
...
public class HorarioEspecialAzureSQLDAO implements HorarioEspecialDAO {

    private final Connection connection;

    public HorarioEspecialAzureSQLDAO(Connection connection) {
