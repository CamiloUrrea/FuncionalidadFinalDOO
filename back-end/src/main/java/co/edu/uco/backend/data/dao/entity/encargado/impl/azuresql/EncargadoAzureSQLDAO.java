package co.edu.uco.backend.data.dao.entity.encargado.impl.azuresql;
...
public class EncargadoAzureSQLDAO implements EncargadoDAO {

    private final Connection connection;

    public EncargadoAzureSQLDAO(Connection connection) {
