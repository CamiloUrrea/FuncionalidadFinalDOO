...
import co.edu.uco.backend.businesslogic.businesslogic.impl.CanchaHorarioEspecialBusinessLogicImpl;
...
public class HorarioEspecialFacadeImpl implements HorarioEspecialFacade {
    ...
    private CanchaHorarioEspecialBusinessLogic businessLogic;

    public HorarioEspecialFacadeImpl() {
        daoFactory = DAOFactory.getFactory(Factory.AZURE_SQL);
        businessLogic = new CanchaHorarioEspecialBusinessLogicImpl(daoFactory);
    }
