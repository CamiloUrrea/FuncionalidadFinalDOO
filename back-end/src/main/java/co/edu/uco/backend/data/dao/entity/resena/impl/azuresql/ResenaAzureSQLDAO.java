package co.edu.uco.backend.data.dao.entity.resena.impl.azuresql;
...
public class ResenaAzureSQLDAO implements ResenaDAO {

    private final Connection connection;

    public ResenaAzureSQLDAO(Connection connection) {
